...
class StudentAttendance extends Model implements ModelInterface
{
    ...
    public function __construct($id = 0, $studentId = 0, $attendanceStatus = 0, $checkIn = null, $checkOut = null, $attendanceDate = null, $leaveReasonId = 0, $sessionId = 0/*DummyConstructArgs*/){
