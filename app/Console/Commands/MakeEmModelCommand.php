...
class MakeEmModelCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'make:emmodel {name?} {props?}';
     ...
     * @var string
     */
    protected $description = 'Create a new emrevo model';
